...
def report_decorator(filename: Optional[str] = None) -> Callable:  # type: ignore[no-untyped-def]
    """
...
def spending_by_workday(transactions: pd.DataFrame, date: Optional[str] = None) -> pd.DataFrame:
    ...
    return pd.DataFrame({"Тип_дня": ["Рабочий", "Выходной"], "Средние_траты": [workday_avg, weekend_avg]})
